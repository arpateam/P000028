...
<head>
    ...
    <!-- Menunggu Konfirmasi View, Sedang Diproses View, Sedang Dikirim View, Sedang Dikirim Aksi, Pesanan Selesai View, Produk View, Blog View, Testimoni View, Sitemap One View, Kasir View -->
    <?php if (($_GET['module']=='menunggu-konfirmasi') AND ($_GET['act']=='view') OR ($_GET['module']=='sedang-diproses') AND ($_GET['act']=='view') OR ($_GET['module']=='sedang-dikirim') AND ($_GET['act']=='view') OR ($_GET['module']=='sedang-dikirim') AND ($_GET['act']=='aksi') OR ($_GET['module']=='pesanan-selesai') AND ($_GET['act']=='view') OR ($_GET['module']=='produk') AND ($_GET['act']=='view') OR ($_GET['module']=='blog' AND $_GET['act']=='view') OR ($_GET['module']=='testimoni' AND $_GET['act']=='view') OR ($_GET['module']=='sitemap-one' AND $_GET['act']=='view') OR ($_GET['module']=='kasir' AND $_GET['act']=='view')): ?>
        <link rel="stylesheet" type="text/css" href="../assets/plugins/DataTables/datatables.min.css"/>
    <?php endif ?>
    <!-- END Menunggu Konfirmasi View, Sedang Diproses View, Sedang Dikirim View, Sedang Dikirim Aksi, Pesanan Selesai View, Produk View, Blog View, Testimoni View, Sitemap One View, Kasir View -->

    <!-- Aksi Menunggu Konfirmasi, Produk Add, Blog Add -->
    <?php if (($_GET['module']=='menunggu-konfirmasi' AND $_GET['act']=='aksi') OR ($_GET['module']=='produk' AND $_GET['act']=='add') OR ($_GET['module']=='blog' AND $_GET['act']=='add')): ?>
    ...
    <?php endif ?>
    <!-- END Aksi Menunggu Konfirmasi, Produk Add, Blog Add -->

    <!-- Pengaturan Edit, Halaman Tanya Jawab Edit, Produk Edit, Blog Edit -->
    <?php if (($_GET['module']=='pengaturan' AND $_GET['act']=='edit') OR ($_GET['module']=='halaman' AND $_GET['act']=='tanya-jawab') OR ($_GET['module']=='produk' AND $_GET['act']=='edit') OR ($_GET['module']=='blog' AND $_GET['act']=='edit')): ?>
        <link rel="stylesheet" href="../assets/plugins/image-upload-arpateam/image-upload-arpateam.css"/>
        <link rel="stylesheet" href="../assets/plugins/summernote-0.8.18/summernote-bs4.css"/>
    <?php endif ?>
    <!-- END Pengaturan Edit, Halaman Tanya Jawab Edit, Produk Edit, Blog Edit -->
...
<body>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item <?php if(($_GET['module']=='blog' AND $_GET['act']=='view') OR ($_GET['module']=='blog' AND $_GET['act']=='add') OR ($_GET['module']=='blog' AND $_GET['act']=='edit')){ echo 'active'; } ?>">
                            <a href="blog">
                        ...
                        <li class="nav-item <?php if(($_GET['module']=='pengaturan' AND $_GET['act']=='video-beranda') OR ($_GET['module']=='pengaturan' AND $_GET['act']=='ubah-video-beranda')){ echo 'active'; } ?>">
                            <a href="video-beranda">
    ...
    <?php if (($_GET['module']=='menunggu-konfirmasi' AND $_GET['act']=='view') OR ($_GET['module']=='sedang-diproses' AND $_GET['act']=='view') OR ($_GET['module']=='sedang-dikirim' AND $_GET['act']=='view') OR ($_GET['module']=='sedang-dikirim') AND ($_GET['act']=='aksi') OR ($_GET['module']=='pesanan-selesai' AND $_GET['act']=='view') OR ($_GET['module']=='produk' AND $_GET['act']=='view') OR ($_GET['module']=='blog' AND $_GET['act']=='view') OR ($_GET['module']=='testimoni' AND $_GET['act']=='view') OR ($_GET['module']=='sitemap-one' AND $_GET['act']=='view') OR ($_GET['module']=='kasir' AND $_GET['act']=='view')): ?>
        ...
        <?php elseif (($_GET['module']=='blog' AND $_GET['act']=='view')): ?>
            <script>
                function confirmHapusBlog(enkripsi) {
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location = "actionDeleteBlog-" + enkripsi;
                        }else{
                            swal({
                                title: "Blog tidak jadi di hapus",
                                icon: "warning",
                                primaryMode: true,
                            })
                        }
    ...
    <?php if (($_GET['module']=='menunggu-konfirmasi' AND $_GET['act']=='aksi') OR ($_GET['module']=='produk' AND $_GET['act']=='add') OR ($_GET['module']=='blog' AND $_GET['act']=='add')): ?>
        ...
        <?php elseif ($_GET['module']=='blog' AND $_GET['act']=='add'): ?>
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    $.upload = function (file) {
                        ...
                        $.ajax({
                            method: 'POST',
                            url: 'actionUploadImgDeskripsiBlog',
                            contentType: false,
                            cache: false,
                            processData: false,
                            data: out,
    ...
    <?php if (($_GET['module']=='pengaturan' AND $_GET['act']=='edit') OR ($_GET['module']=='halaman' AND $_GET['act']=='tanya-jawab') OR ($_GET['module']=='produk' AND $_GET['act']=='edit') OR ($_GET['module']=='blog' AND $_GET['act']=='edit')): ?>
        ...
        <?php elseif ($_GET['module']=='blog' AND $_GET['act']=='edit'): ?>
            <script type="text/javascript">
                $(document).ready(function(){
    ...
    <!-- Video Beranda -->
    <?php if (($_GET['module']=='pengaturan' AND $_GET['act']=='video-beranda') OR ($_GET['module']=='pengaturan' AND $_GET['act']=='ubah-video-beranda')): ?>
    <script>
        ...
        $(document).ready(function(){
            $("#upload").click(function(){
                ...
                if (file!="") {
                    ...
                    ajax.open("POST", "actionVideoBeranda");
                    ajax.send(formdata);
                }
            });
        });
