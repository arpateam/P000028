...
if (empty($_SESSION['_kode_login__'])) {
    ...
    // Data file
    $link                   = "blog";
    $penyimpananGambar      = "../../assets/images/blog";
    $penyimpananGambarSmall = "../../assets/images/blog/small";
    $database               = "blog";
    $act                    = $_GET["act"];
    // Data file
    ...
    if ($_GET['act']==="01") {
        ...
        // SiteMap 1
            ...
            $id_sub_sitemap     = 3;
            $loc_1              = $link1."/blog/".$judul_seo.".html";
            $priority_1         = "0.80";
        // SiteMap 1
    ...
    elseif ($_GET['act']==="02") {
        ...
        $id_blog    = htmlspecialchars($_POST['___in_id_blog_special_SEMANAK']);
        $judul          = htmlspecialchars($_POST['___in_judul_special_SEMANAK']);
        $judul_seo      = seo($judul)."-".rand(00,99);
        ...
        try {
            ...
            if ($count>0) {
                $_SESSION['_msg__']  = "Berhasil";
                echo "<script>window.location = 'ubah-$link-$id_blog'</script>";
                die();
                exit();
            }
        }catch(PDOException $e){
    ...
    // Hapus data
    elseif ($_GET['act']=='03'){
        $Data           = $pdo->query("SELECT gambar, id_sitemap_1 FROM $database WHERE id_blog='$_GET[id]'");
