				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="alert alert-primary" role="alert">
							<?php
								$SUMblog = $pdo->query("SELECT * FROM $database WHERE id_sub_sitemap='3'");
								$resultSUMblog = $SUMblog->rowCount();
							?>

						  	<p>Jumlah URL <strong class="text-primary">Blog 1</strong> Saat Ini <i>(max. <?= rp(50000); ?> Urls)</i></p>
						  	<h3 class="text-primary font-weight-bold"><?= $resultSUMblog; ?> URLS &nbsp;&nbsp;&nbsp; <span class="border"></span> &nbsp;&nbsp;&nbsp; <a data-toggle="collapse" href="#collapseBlog" role="button" aria-expanded="false" aria-controls="collapseBlog"><i class="fas fa-caret-square-down"></i></a> </h3>
						  	<div class="card-body border-top border-primary shadow collapse" id="collapseBlog">
								<div class="table-responsive">
									<table id="tabelSitemapBlog" class="table table-striped table-bordered py-2" style="width:100%">
								        <thead>
											<tr>
												<th scope="col">No</th>
												<th scope="col" style="width: 250px;">Link/Location</th>
										...
										<tbody>
											...
											<?php
												...
												$no=1;
												$Blog = $pdo->query("SELECT * FROM $database WHERE id_sub_sitemap='3'");
												while($resultBlog = $Blog->fetch(PDO::FETCH_ASSOC)){

											?>

											<tr>
												<th scope="row"><?= $no++; ?></th>
												<td><?= $resultBlog['loc_1']; ?></td>
												<td><?= $resultBlog['lastmod_1']; ?></td>
												<td><?= $resultBlog['priority_1']; ?></td>
												<td>
													<a href="edit-<?= $link; ?>-<?= $resultBlog['id_sitemap_1']; ?>" role="button" class="btn btn-sm btn-primary px-3"><i class="fas fa-edit"></i></a>
													<a href="<?= $aksi; ?>?module=<?= $module; ?>&act=delete&id_sitemap_1=<?= $resultBlog['id_sitemap_1']; ?>" role="button" class="btn btn-sm btn-danger px-3"><i class="fas fa-trash-alt"></i></a>
												</td>
											</tr>
						  	...
						  	<hr />
						  	<span>Ukuran <strong class="text-primary">sitemapblog1.php</strong> adalah <strong class="text-primary"><?= rp(filesize("../sitemapblog1.php")); ?> Bytes</strong> <i>(max. <?= rp(50000000); ?> Bytes)</i></span>
						</div>
					</div>
				</div>
			</div>
