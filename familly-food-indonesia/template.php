...
<body>
	...
	<!-- <script type="text/javascript">
	    (function () {
	        var options = {
	            whatsapp: "<?= $nomorWhatsApp1 ?>", // WhatsApp number
	            link: "https://api.whatsapp.com/send?phone=<?= whatsApp($nomorWhatsApp1); ?>&text=Hallo%20<?= $namaweb ?>...", // Link
	            link_color: "#A8CE50", // Link button color
	            call_to_action: "Kontak Layanan 24 Jam", // Call to action
	            button_color: "#FFA726", // Color of button
	            position: "left", // Position may be 'right' or 'left'
	            order: "whatsapp,whatsapp", // Order of buttons
	            pre_filled_message: "Hallo <?= $namaweb ?>...", // WhatsApp pre-filled message
	        };
