    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link p-2 p-md-2 mt-2 mt-md-0 <?php if ($_GET['module']==='tanya-jawab') { echo 'active'; } ?>" href="tanya-jawab">Tanya Jawab</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link p-2 p-md-2 mt-2 mt-md-0" href="blog/">Blog</a>
                </li>
                <li class="nav-item">
