...
if(($_GET['module']=='home') OR ($_GET['module']=='produk') OR ($_GET['module']=='testimoni') OR ($_GET['module']=='tanya-jawab') OR ($_GET['module']=='blog') OR ($_GET['module']=='promo') OR ($_GET['module']=='keranjang')){
	...
	$urlshare = $default4;
}elseif($_GET['module']=='read-opini'){
	$Detail 	= $pdo->query("SELECT judul,judul_seo,gambar,keyword,description FROM opini WHERE judul_seo='$_GET[judul_seo]'");
	...
	$imageshare = "assets/images/opini/small/$tDetail[gambar]";
	$urlshare 	= "$default4/opini/$tDetail[judul_seo].html";
	
}elseif($_GET['module']=='read-blog'){
	$Detail 	= $pdo->query("SELECT judul,judul_seo,gambar,keyword,description FROM blog WHERE judul_seo='$_GET[judul_seo]'");
	$tDetail 	= $Detail->fetch(PDO::FETCH_ASSOC);
	...
	$imageshare = "assets/images/blog/small/$tDetail[gambar]";
	$urlshare 	= "$default4/blog/$tDetail[judul_seo].html";
